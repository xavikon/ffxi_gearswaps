...
function init_gear_sets()
    ...
    sets.precast.WS = {ammo="Jukukik Feather",
        head="Adhemar Bonnet",neck="Anu torque",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Beghanada Cuirie",hands="Adhemar Writbands",ring1="Rajas Ring",ring2="Apate Ring",
        back="Bleating Mantle",waist="Kentarch Belt",legs="Samnuha Tights",feet="Lustratio Leggings"}
    ...
    sets.idle = {ammo="Iron Gobbet",
        ...
        back="Solemnity Cape",waist="Flume Belt",legs="Qaaxo Tights",feet="Skadi's Jambeaux +1"}
    
    sets.idle.Weak = {ammo="Iron Gobbet",
        head="Felistris Mask",neck="Wiglen Gorget",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Adhemar Jacket",hands="Buremte Gloves",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Solemnity Cape",waist="Flume Belt",legs="Kaabnax Trousers",feet="Skadi's Jambeaux +1"}
    ...
    sets.defense.PDT = {ammo="Iron Gobbet",
        ...
        back="Solemnity Cape",waist="Flume Belt",legs="Nahtirah Trousers",feet="Iuitl Gaiters +1"}
    ...
    sets.defense.MDT = {ammo="Demonry Stone",
        ...
        back="Solemnity Cape",waist="Flume Belt",legs="Wayfarer Slops",feet="Wayfarer Clogs"}
    ...
    sets.engaged = {ammo="Jukukik Feather",
        ...
        body="Meghanada Cuirie",hands="Adhemar Wristbands",ring1="Rajas Ring",ring2="Apate Ring",
        back="Bleating Mantle",waist="Dynamic belt",legs="Samnuha Tights",feet="Rawhide Boots"}
    ...
    sets.engaged.Acc = {ammo="Falcon Eye",
        head="Whirlpool Mask",neck="Subtlety Spec.",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Charis Casaque +2",hands="Iuitl Wristbands",ring1="Rajas Ring",ring2="Cacoethic Ring",
        back="Grounded Mantle",waist="Kentarch Belt",legs="Qaaxo Tights",feet="Meg. Jam. +1"}
