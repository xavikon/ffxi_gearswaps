...
function init_gear_sets()
	...
	sets.precast.FC = {main="Vampirism",sub="Genbu's shield",ammo="Impatiens",
		head="Haruspex hat",neck="Voltsurge Torque",ear1="Etiolation earring",ear2="Loquacious Earring",
		body="Samnuha coat",hands="Leyline Gloves",ring1="Prolix ring",
		back="Switch Cape",waist="Witful Belt",feet="Chelona boots"}
	...
	sets.precast.WS = {ammo="Ginsen",head="Lilitu Headpiece",neck="Fotia Gorget",ear1="Moonshade earring",ear2="Brutal Earring",
                                  body="Rawhide Vest",hands="Leyline gloves",ring1="Epona's Ring",ring2="Ramuh Ring",
				  back="Lupine Cape",waist="Fotia Belt",legs="Samnuha Tights",feet="Taeon boots"}
				  
	sets.precast.WS.FullAcc = {ammo="Honed Tathlum",head="Lilitu Headpiece",neck="Subtlety Spec.",ear1="Moonshade earring",ear2="Brutal Earring",
                                  body="Rawhide Vest",hands="Leyline gloves",ring1="Epona's Ring",ring2="Ramuh Ring",
				  back="Lupine Cape",waist="Hurch'lan sash",legs="Samnuha Tights",feet="Taeon boots"}
	...
	sets.precast.WS['Chant du Cygne'] = set_combine(sets.precast.WS, {ammo="Jukukik Feather",neck="Tjukurrpa Medal",head="Lilitu Headpiece",ear1="Moonshade Earring",body="Rawhide Vest",legs="Samnuha tights",hands="Leyline Gloves",ring1="Ramuh Ring",ring2="Ramuh Ring",back="Rancorous Mantle",feet="Battlecast Gaiters"})
	sets.precast.WS['Chant du Cygne'].FullAcc = set_combine(sets.precast.WS.FullAcc, {})
	
	sets.precast.WS['Savage Blade'] = set_combine(sets.precast.WS, {head="Lilitu Headpiece",neck="Tjukurrpa Medal",ear1="Regal Earring",ear2="Moonshade Earring",body="Rawhide Vest",hands="Leyline Gloves",ring1="Ifrit Ring",ring2="Petrov Ring",back="Cornflower Cape",waist="Metalsinger Belt",legs="Samnuha tights",feet="Battlecast Gaiters"})
	...
	sets.precast.WS['Expiacion'] = set_combine(sets.precast.WS, {head="Lilitu Headpiece",neck="Tjukurrpa Medal",ear2="Flame Pearl",body="Rawhide Vest",hands="Leyline Gloves",ring1="Ifrit Ring",ring2="Petrov Ring",back="Cornflower Cape",waist="Metalsinger Belt",legs="Samnuha tights",feet="Battlecast Gaiters"})
	sets.precast.WS['Expiacion'].FullAcc = set_combine(sets.precast.WS.FullAcc, {})
	

	--sets.precast.WS['Sanguine Blade'] = {ammo="Pemphredo Tathlum",head="Pixie Hairpin +1",neck="Baetyl Pendant",ear1="Regal Earring",ear2="Friomisi Earring",
	...
	sets.midcast['Blue Magic'].Magical = {main="Vampirism",sub="Bolelabunga",ammo="Mavi Tathlum",
					 head="Helios band",neck="Eddy necklace",ear1="Hecate's Earring",ear2="Friomisi Earring",
					 body="Samnuha coat",hands="Helios gloves",ring1="Shiva Ring",ring2="Shiva Ring",
	...
	-- Idle sets
	sets.idle = {ammo="Inlamvuyeso",head="Dampening Tam",body="Vrikodara Jupon",neck="Bathy Choker",left_ear="Etiolation Earring",
                        left_ring="Defending Ring",right_ring="Shneddick Ring",back="Shadow Mantle",feet="Battlecast gaiters"}
	
	sets.idle.Sphere = {}

	sets.idle.PDT = {main="Vampirism",sub="Genbu's Shield",ammo="Inlamvuyeso",head="Iuitl Headgear +1",neck="Twilight Torque",ear1="Etiolation Earring",
		        body="Vrikodara Jupon",ring1="Defending Ring",ring2="Dark Ring",back="Shadow mantle",waist="Flax Sash",legs="Hagondes Pants",feet="Battlecast gaiters"}
	...
	sets.defense.PDT = {main="Terra's Staff",sub="Umbra Strap",ammo="Staunch Tathlum",
				...
				back="Moonbeam Cape",waist="twilight belt",legs=gear.herculean_dt_legs,feet=gear.herculean_dt_feet}
    ...
    sets.defense.MEVA = {head="Helios Band",neck="Twilight Torque",ear1="Etiolation Earring",
		body="Vrikodara Jupon",hands="Leyline Gloves",
                waist="Flax Sash",legs="Psycloth Lappas",feet="Helios boots"}
	...
	sets.engaged = {main="Tizona", sub="Nibiru blade",ammo="Ginsen",
			    head="Dampening Tam",neck="Asperity Necklace",ear1="Steelflash earring",ear2="Bladeborn Earring",
			    body="Rawhide vest",hands="Taeon gloves",ring1="Epona's Ring",ring2="Petrov Ring",
			    back="Bleating mantle",waist="twilight belt",legs="Samnuha Tights",feet="Taeon boots"}
				
	sets.engaged.FullAcc = set_combine(sets.engaged, {ammo="Honed tathlum",
				neck="Subtlety Spec.",ring1="Ramuh Ring",back="Lupine Cape",waist="Hurch'lan Sash"})
