...
function init_gear_sets()
    ...
    sets.precast.BloodPactWard = {main="Espiritus",sub="Vox Grip",ammo="Sancus Sachet +1",
        ...
        body="Con. Doublet +3",hands="Lamassu Mitts +1",ring1="Evoker's Ring",ring2="Stikini Ring",
    ...
    sets.midcast.Pet.PhysicalBloodPactRage = {main="Gridarvor",sub="Elan Strap",ammo="Sancus Sachet +1",
        ...
        back=gear.phys_jse_back,waist="Incarnation Sash",legs="Enticer's Pants",feet="Convo. Pigaches +3"}
		
    sets.midcast.Pet.PhysicalBloodPactRage.Acc = sets.midcast.Pet.PhysicalBloodPactRage

    sets.midcast.Pet.MagicalBloodPactRage = {main="Espiritus",sub="Elan Strap",ammo="Sancus Sachet +1",
        head=gear.merlinic_magpact_head,neck="Adad Amulet",ear1="Gelos Earring",ear2="Lugalbanda Earring",
	...
	sets.midcast.Pet['Flaming Crush'] = {main="Espiritus",sub="Elan Strap",ammo="Sancus Sachet +1",
        head="Apogee Crown",neck="Adad Amulet",ear1="Gelos Earring",ear2="Domesticator's Earring",
        body="Apogee Dalmatica",hands=gear.merlinic_magpact_hands,ring1="Varar Ring",ring2="Varar Ring",
    ...
    sets.idle.Avatar = {main="Gridarvor",sub="Oneiros Grip",ammo="Sancus Sachet +1",
        ...
        body="Shomonjijoe +1",hands="Asteria Mitts +1",ring1="Evoker's Ring",ring2="Dark Ring",
	...
	sets.HPDown = {head="Apogee Crown",ear1="Mendicant's Earring",ear2="Evans Earring",
		body="Apogee Dalmatica",hands=empty,ring1="Mephitas's Ring +1",ring2="Mephitas's Ring",
		back="Swith Cape +1",legs="Shedir Seraweels",feet="Apogee Pumps"}
	
	sets.buff.Doom = set_combine(sets.buff.Doom, {})
	sets.buff.Sleep = {neck="Sacrifice Torque"}
	sets.Weapons = {main="Gridarvor", sub="Elan Strap"}
    --------------------------------------
    -- Engaged sets
    --------------------------------------
    ...
    sets.engaged = {main="Gridarvor",sub="Bloodrain Strap",ammo="Sancus Sachet +1",
        ...
        body="Con. Doublet +3",hands=gear.merlinic_refresh_hands,ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
