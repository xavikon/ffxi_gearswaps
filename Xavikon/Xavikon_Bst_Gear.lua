function user_setup()
	...
	state.ExtraMeleeMode = M{['description']='Extra Melee Mode', 'None', 'Knockback', 'SuppaBrutal', 'DAEarrings', 'DWEarrings'}
...
function init_gear_sets()
	...
	sets.precast.JA.Reward = {
                ...
                body="Tot. Jackcoat +1",hands="Regimen Mittens",ring1="Globidonta Ring",ring2="Sirona's Ring",
	...
	-- CURING WALTZ
	sets.precast.Waltz = {
                head="Yaoyotl Helm",neck="Loricate Torque +1",ear1="Enchanter Earring +1",ear2="Handler's Earring +1",
                body="Tot. Jackcoat +1",hands="Regimen Mittens",ring1="Valseur's Ring",ring2="Asklepian Ring",
                back="Mollusca Mantle",waist="Chaac Belt",legs="Desultor Tassets",feet="Acro Leggings"}
	...
	sets.precast.Step = {ammo="Hasty Pinion +1",
                ...
                body="Mes. Haubergeon",hands="Leyline Gloves",ring1="Cacoethic Ring",ring2="Cacoethic Ring +1",
    ...
    sets.midcast.FastRecast = {
                ...
                back="Mollusca Mantle",waist="Hurch'lan Sash",legs="Nukumi Quijotes +1",feet="Tot. Gaiters +1"}
 
	sets.midcast.Utsusemi = set_combine(sets.midcast.FastRecast, {back="Mujin Mantle"})
 
	sets.midcast.Cure = {
                head="Gavialis Helm",neck="Phalaina Locket",ear1="Etiolation Earring",ear2="Handler's Earring +1",
                body="Jumalik Mail",hands="Macabre Gaunt. +1",ring1="Lebeche Ring",ring2="Sirona's Ring",
                back="Pastoralist's Mantle",waist="Hurch'lan Sash",legs="Nukumi Quijotes +1",feet="Tot. Gaiters +1"}
	...
	sets.midcast.Cursna = set_combine(sets.midcast.FastRecast, {neck="Malison Medallion",ring1="Haoma's Ring",ring2="Haoma's Ring"})
	...
	sets.precast.WS = {ammo="Hasty Pinion +1",
                head="Otomi Helm",neck="Fotia Gorget",ear1="Kokou's Earring",ear2="Brutal Earring",
                body="Mes. Haubergeon",hands="Buremte Gloves",ring1="Rajas Ring",ring2="Epona's Ring",
                back="Buquwik Cape",waist="Fotia Belt",legs="Meg. Chausses +1",feet="Ejekamal Boots"}
	...
	sets.precast.WS.SomeAcc = {ammo="Hasty Pinion +1",
                ...
                body="Mes. Haubergeon",hands="Buremte Gloves",ring1="Rajas Ring",ring2="Epona's Ring",
                back="Letalis Mantle",waist="Fotia Belt",legs="Meg. Chausses +1",feet="Ejekamal Boots"}
	...
	sets.precast.WS.Acc = {ammo="Hasty Pinion +1",
                ...
                body="Mes. Haubergeon",hands="Leyline Gloves",ring1="Rajas Ring",ring2="Cacoethic Ring +1",
                back="Letalis Mantle",waist="Anguinus Belt",legs="Meg. Chausses +1",feet="Nukumi Ocreae +1"}
				
	sets.precast.WS.FullAcc = {ammo="Hasty Pinion +1",
                head="Yaoyotl Helm",neck="Combatant's Torque",ear1="Zennaroi Earring",ear2="Steelflash Earring",
                body="Mes. Haubergeon",hands="Leyline Gloves",ring1="Cacoethic Ring",ring2="Cacoethic Ring +1",
    ...
    sets.precast.WS['Onslaught'] = set_combine(sets.precast.WS, {feet="Vanir Boots"})
    ...
    sets.precast.WS['Primal Rend'] = {ammo="Dosis Tathlum",
                ...
                body="Jumalik Mail",hands="Leyline Gloves",ring1="Acumen Ring",ring2="Vertigo Ring",
                back="Toro Cape",waist="Fotia Belt",legs="Nukumi Quijotes +1",feet="Tot. Jackcoat +1"}
    ...
    sets.midcast.Pet.WS = {ammo="Demonry Core",
		head="Totemic Helm +1",neck="Empath Necklace",ear2="Domesticator's Earring", --ear1="Sabong Earring",
        body="Taeon Tabard",hands="Nukumi Manoplas +1",
        back="Pastoralist's Mantle",waist="Incarnation Sash",legs="Nukumi Quijotes +1",feet="Totemic Gaiters +1"}
 
	sets.midcast.Pet.MagicReady = set_combine(sets.midcast.Pet.WS, {head="Valorous Mask",legs="Valor. Hose",feet="Valorous Greaves"})
        ...
        sets.idle = {ammo="Staunch Tathlum",
                ...
                back="Solemnity Cape",waist="Flume Belt",legs="Nukumi Quijotes +1",feet="Skd. Jambeaux +1"}
 
        sets.idle.Refresh = set_combine(sets.idle, {})
        sets.idle.Reraise = set_combine(sets.idle, {head="Twilight Helm",body="Twilight Mail"})
 
        sets.idle.Pet = {ammo="Demonry Core",
                head="Anwig Salade",neck="Empath Necklace",ear1="Sanare Earring",ear2="Handler's Earring +1",
                body="Taeon Tabard",hands="Ankusa Gloves +1",ring1="Defending Ring",ring2="Sheltered Ring",
                back="Pastoralist's Mantle",waist="Isa Belt",legs="Nukumi Quijotes +1",feet="Ankusa Gaiters +1"}
 
        sets.idle.Pet.Engaged = {ammo="Demonry Core",
                head="Anwig Salade",neck="Empath Necklace",ear1="Domesticator's Earring",ear2="Handler's Earring +1",
        ...
        sets.defense.PDT = {ammo="Staunch Tathlum",
                ...
                back="Mollusca Mantle",waist="Flume Belt",legs="Nukumi Quijotes +1",feet="Nukumi Ocreae +1"}
 
        sets.defense.PetPDT = {ammo="Demonry Core",
                head="Anwig Salade",neck="Empath Necklace",ear1="Domesticator's Earring",ear2="Handler's Earring +1", --ear1="Handler's Earring",
                body="Taeon Tabard",hands="Ankusa Gloves +1",ring1="Defending Ring",ring2="Dark Ring",
                back="Pastoralist's Mantle",waist="Isa Belt",legs="Nukumi Quijotes +1",feet="Ankusa Gaiters +1"}
				
        sets.defense.PetMDT = {ammo="Demonry Core",
                head="Anwig Salade",neck="Empath Necklace",ear2="Handler's Earring +1", --ear1="Handler's Earring",
                body="Taeon Tabard",hands="Ankusa Gloves +1",ring1="Defending Ring",ring2="Dark Ring",
                back="Pastoralist's Mantle",waist="Isa Belt",legs="Nukumi Quijotes +1",feet="Ankusa Gaiters +1"}
        ...
        sets.defense.MDT = {ammo="Staunch Tathlum",
                ...
                back="Engulfer Cape +1",waist="Engraved Belt",legs="Nukumi Quijotes +1",feet="Nukumi Ocreae +1"}
		...
		sets.defense.MEVA = {
			...
			back="Toro Cape",waist="Engraved Belt",legs="Acro Breeches",feet="Acro Leggings"}
    ...
    sets.engaged = {ammo="Ginsen",
        ...
        back="Bleating Mantle",waist="Windbuffet Belt +1",legs="Meg. Chausses +1",feet="Acro Leggings"}
		
    sets.engaged.SomeAcc = {ammo="Falcon Eye",
        head="Whirlpool Mask",neck="Defiant Collar",ear1="Bladeborn Earring", ear2="Steelflash Earring",
        body="Acro Surcoat",hands="Leyline Gloves",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Letalis Mantle",waist="Windbuffet Belt +1",legs="Meg. Chausses +1",feet="Acro Leggings"}
    
	sets.engaged.Acc = {ammo="Falcon Eye",
        head="Whirlpool Mask",neck="Combatant's Torque",ear1="Zennaroi Earring",ear2="Brutal Earring",
        body="Mes. Haubergeon",hands="Leyline Gloves",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Letalis Mantle",waist="Anguinus Belt",legs="Acro Breeches",feet="Acro Leggings"}
		
    sets.engaged.FullAcc = {ammo="Falcon Eye",
        head="Whirlpool Mask",neck="Combatant's Torque",ear1="Zennaroi Earring",ear2="Steelflash Earring",
        body="Mes. Haubergeon",hands="Leyline Gloves",ring1="Cacoethic Ring",ring2="Cacoethic Ring +1",
        back="Ground. Mantle +1",waist="Olseni Belt",legs="Acro Breeches",feet="Acro Leggings"}
		        
    sets.engaged.Fodder = {ammo="Ginsen",
        head="Acro Helm",neck="Asperity Necklace",ear1="Trux Earring",ear2="Brutal Earring",
        body="Acro Surcoat",hands="Acro Gauntlets",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Bleating Mantle",waist="Windbuffet Belt +1",legs="Meg. Chausses +1",feet="Acro Leggings"}
    ...
    sets.engaged.PDT = {ammo="Staunch Tathlum",
        ...
        back="Mollusca Mantle",waist="Flume Belt",legs="Meg. Chausses +1",feet="Acro Leggings"}
	...
	sets.engaged.Acc.PDT = {ammo="Falcon Eye",
        head="Acro Helm",neck="Loricate Torque +1",ear1="Bladeborn Earring", ear2="Steelflash Earring",
        body="Jumalik Mail",hands="Buremte Gloves",ring1="Defending Ring",ring2="Dark Ring",
        back="Mollusca Mantle",waist="Flume Belt",legs="Meg. Chausses +1",feet="Acro Leggings"}
    ...
    sets.engaged.DW.SomeAcc = {ammo="Falcon Eye",
        head="Whirlpool Mask",neck="Defiant Collar",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Acro Surcoat",hands="Leyline Gloves",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Letalis Mantle",waist="Windbuffet Belt +1",legs="Meg. Chausses +1",feet="Acro Leggings"}
    ...
    sets.engaged.DW.Fodder = {ammo="Ginsen",
        head="Acro Helm",neck="Asperity Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Acro Surcoat",hands="Acro Gauntlets",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Bleating Mantle",waist="Shetal Stone",legs="Meg. Chausses +1",feet="Acro Leggings"}
