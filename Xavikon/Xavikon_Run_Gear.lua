...
function init_gear_sets()
    ...
    sets.engaged = {main="Zulfiqar",sub="Utu Grip",ammo="Ginsen",
                        head="Aya. Zucchetto +1",neck="Lissome necklace",ear1="Telos earring",ear2="Brutal Earring",
                        body=gear.melee_herc_body,hands="Adhemar Wristbands",ring1="Petrov Ring",ring2="Epona's Ring",
                        back="Ogma's cape",waist="Windbuffet belt +1",legs="Samnuha Tights",feet="Aya. Gambieras +1"}
    sets.engaged.Acc = set_combine(sets.engaged, {ear2="Mache Earring",body="Ayanmo Corazza +1",ring2="Cacoethic Ring +1",waist="Ioskeha Belt",})
	sets.engaged.HighAcc = set_combine(sets.engaged.Acc,{hands="Meg. Gloves +2",waist="Anguinus Belt",legs="Carmine Cuisses +1",feet="Meg. Jam. +1"}
	sets.engaged.Fodder = {}
	
    sets.engaged.Tank = {main="Aettir",sub="Mensch Strap",ammo="Staunch Tathlum",
                        head="Aya. Zucchetto +1",neck="Twilight Torque",ear1="Odnowa Earring +1",ear2="Odnowa Earring",
                        body="Ayanmo corazza +1",hands="Meg. Gloves +2",ring1="Defending Ring",ring2="Moonbeam Ring",
                        back="Moonbeam Cape",waist="Flume Belt",legs="Herculean Trousers",feet="Aya. Gambieras +1"}
